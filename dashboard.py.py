...
def get_data(query):
    # Check if the database file exists locally; if not, download it
    db_file = "retail_data.db"
    if not os.path.exists(db_file):
        # URL of the database file stored on Google Drive (replace with your actual link)
        db_url = "https://drive.google.com/file/d/1SEEfaaKxbmX3gaHwyCpOpqFbyAUw3BB4/view?usp=sharing"
